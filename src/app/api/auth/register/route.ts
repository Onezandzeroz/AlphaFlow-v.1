...
export async function POST(request: NextRequest) {
  try {
    ...
    // NOTE: No session is created here. The user must verify their email
    // before they can log in. The frontend will show a "check your email"
    ...
    // Return success with email — user must verify before logging in
    return NextResponse.json({
      success: true,
      email: normalizedEmail,
