  ...
  return (
    <div className="p-3 lg:p-6 space-y-4 lg:space-y-6">
      ...
      <PageHeader
        ...
        action={
          <Button onClick={handleExportCSV} className="bg-white/20 hover:bg-white/30 text-white border border-white/30 backdrop-blur-sm gap-2 font-medium transition-all">
