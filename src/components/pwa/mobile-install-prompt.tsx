...
export function MobileInstallPrompt() {
  ...
  return (
    <div className="lg:hidden relative w-full mb-4 animate-in slide-in-from-bottom-2 duration-500">
      <div className="relative rounded-2xl bg-white dark:bg-[#1a1f1e] border border-[#e2e8e6] dark:border-[#2a3330] shadow-lg p-4">
        {/* Dismiss button */}
        <button
          ...
          <div className="flex-1 min-w-0">
            ...
            {platform === 'android' && (
              <div className="mt-1.5 space-y-2">
                {showInstall ? (
                  <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                    Installer AlphaAi som app for fuld skærm uden browser-linje.
                  </p>
                ) : (
                  <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                    Tryk på
